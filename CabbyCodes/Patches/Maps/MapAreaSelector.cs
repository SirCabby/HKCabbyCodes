...
{
    public class MapAreaSelector : ISyncedReference<int>, ISyncedValueList
    {
        private int currentIndex;
        private readonly List<string> areaNames;

        public MapAreaSelector(int defaultIndex = 0)
        {
            areaNames = Scenes.Areas.GetAllAreaNames().ToList();
