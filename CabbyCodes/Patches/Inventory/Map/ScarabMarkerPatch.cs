...
namespace CabbyCodes.Patches.Inventory.Map
{
    ...
    {
        private static readonly FlagDef flag1 = FlagInstances.hasMarker_b;
        ...
        {
            CabbyCodesPlugin.cabbyMenu.AddCheatPanel(new TogglePanel(new ScarabMarkerPatch(), flag1.ReadableName));
        }
    }
}
